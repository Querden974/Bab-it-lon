...
**Auteur :** Maxime COURBOULIN  |  **Date :** 2026-02-12 00:00:00
...
![CloneZilla](../../../../../../assets/notes/image/attachments/clonezilla.png)

![CloneZilla](../../../../../../assets/notes/image/attachments/clonezilla-1.png)

![CloneZilla](../../../../../../assets/notes/image/attachments/clonezilla-2.png)

## Configuration 

Choix du langage :

![CloneZilla](../../../../../../assets/notes/image/attachments/clonezilla-3.png)

Choix du clavier :

![CloneZilla](../../../../../../assets/notes/image/attachments/clonezilla-4.png)

Changer clavier > 105 touches > Autres > Français AZERTY

![CloneZilla](../../../../../../assets/notes/image/attachments/clonezilla-5.png)

## Choisir l’origine et la destination 

![CloneZilla](../../../../../../assets/notes/image/attachments/clonezilla-6.png)

![CloneZilla](../../../../../../assets/notes/image/attachments/clonezilla-7.png)

![CloneZilla](../../../../../../assets/notes/image/attachments/clonezilla-8.png)

Choisir la destination :

![CloneZilla](../../../../../../assets/notes/image/attachments/clonezilla-9.png)

Vérification :

![CloneZilla](../../../../../../assets/notes/image/attachments/clonezilla-10.png)

Choix du répertoire :

![CloneZilla](../../../../../../assets/notes/image/attachments/clonezilla-11.png)

Style assistant :

![CloneZilla](../../../../../../assets/notes/image/attachments/clonezilla-12.png)

Choix du mode :

![CloneZilla](../../../../../../assets/notes/image/attachments/clonezilla-13.png)

Choix du nom de l’image :

![CloneZilla](../../../../../../assets/notes/image/attachments/clonezilla-14.png)

# Choisir de quel disque faire l’image (Espace pour cocher avec \*) :

![CloneZilla](../../../../../../assets/notes/image/attachments/clonezilla-15.png)

Choix du mode de **Savedisk** :

![CloneZilla](../../../../../../assets/notes/image/attachments/clonezilla-16.png)

Vérification et réparation :

![CloneZilla](../../../../../../assets/notes/image/attachments/clonezilla-17.png)

Vérification post installation :

![CloneZilla](../../../../../../assets/notes/image/attachments/clonezilla-18.png)

Chiffrement de l’image :

![CloneZilla](../../../../../../assets/notes/image/attachments/clonezilla-19.png)

Sauvegarde sur Clef USB :

![CloneZilla](../../../../../../assets/notes/image/attachments/clonezilla-20.png)

Tâche après l’installation :

![CloneZilla](../../../../../../assets/notes/image/attachments/clonezilla-21.png)

![CloneZilla](../../../../../../assets/notes/image/attachments/clonezilla-22.png)

Dernière validation :

![CloneZilla](../../../../../../assets/notes/image/attachments/clonezilla-23.png)

Création :

![CloneZilla](../../../../../../assets/notes/image/attachments/clonezilla-24.png)
...
*Clonezilla* refusera pour préparer l’espace de destination, pour cela il est nécessaire de faire la manipulation suivante :

Remonter toutes les fenêtres jusqu’à :

![CloneZilla](../../../../../../assets/notes/image/attachments/clonezilla-25.png)
