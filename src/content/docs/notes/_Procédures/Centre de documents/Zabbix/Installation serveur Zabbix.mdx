...
import mpvhtq from '../../../../../../assets/notes/image/image/_zabbix-1775635342127.jpeg'

import kqnfec from '../../../../../../assets/notes/image/image/_zabbix-1775640911617.jpeg'

import tjheey from '../../../../../../assets/notes/image/image/_zabbix-1775640969131.jpeg'

import yzelsa from '../../../../../../assets/notes/image/image/_zabbix-1775641026123.jpeg'

import epozzn from '../../../../../../assets/notes/image/image/_zabbix-1775641427967.jpeg'
...
Vérifier que tout les prérequis ont tous le statut "<font color="#92d050">OK</font>" <Image src={mpvhtq} alt="" width="750" height="auto" />
...
|                                                                                                                                                                                                                                                                                                               |                                                                                                                                                                                                                              |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Sélectionner un Template en cliquant sur `Select` <br/><br/>Cliquer à nouveau sur `Select` pour sélectionner un groupe de template.<br/>Sélectionner `Templates/Operating systems`                                                                                                                            | <Image src={kqnfec} alt="" width="400" height="auto" /><Image src={tjheey} alt="" width="400" height="auto" /><Image src={yzelsa} alt="" width="400" height="auto" /><Image src={epozzn} alt="" width="400" height="auto" /> |
