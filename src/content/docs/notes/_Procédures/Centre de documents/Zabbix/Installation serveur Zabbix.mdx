...
import jokklt from '../../../../../../assets/notes/image/image/_zabbix-1775635342127.jpeg'

import pffoms from '../../../../../../assets/notes/image/image/_zabbix-1775640911617.jpeg'

import uynjru from '../../../../../../assets/notes/image/image/_zabbix-1775640969131.jpeg'

import tdgrwv from '../../../../../../assets/notes/image/image/_zabbix-1775641026123.jpeg'

import eoqurc from '../../../../../../assets/notes/image/image/_zabbix-1775641427967.jpeg'
...
Vérifier que tout les prérequis ont tous le statut "<font color="#92d050">OK</font>" <Image src={jokklt} alt="" width="750" height="auto" />
...
|                                                                                                                                                                                                                                                                                                               |                                                                                                                                                                                                                              |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Sélectionner un Template en cliquant sur `Select` <br/><br/>Cliquer à nouveau sur `Select` pour sélectionner un groupe de template.<br/>Sélectionner `Templates/Operating systems`                                                                                                                            | <Image src={pffoms} alt="" width="400" height="auto" /><Image src={uynjru} alt="" width="400" height="auto" /><Image src={tdgrwv} alt="" width="400" height="auto" /><Image src={eoqurc} alt="" width="400" height="auto" /> |
