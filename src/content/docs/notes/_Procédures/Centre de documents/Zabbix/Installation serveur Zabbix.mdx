...
import asewnf from '../../../../../../assets/notes/image/image/_zabbix-1775635342127.jpeg'

import zljruj from '../../../../../../assets/notes/image/image/_zabbix-1775640911617.jpeg'

import fjkxur from '../../../../../../assets/notes/image/image/_zabbix-1775640969131.jpeg'

import abvxlw from '../../../../../../assets/notes/image/image/_zabbix-1775641026123.jpeg'

import ufotsa from '../../../../../../assets/notes/image/image/_zabbix-1775641427967.jpeg'
...
Vérifier que tout les prérequis ont tous le statut "<font color="#92d050">OK</font>" <Image src={asewnf} alt="" width="750" height="auto" />
...
|                                                                                                                                                                                                                                                                                                               |                                                                                                                                                                                                                              |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Sélectionner un Template en cliquant sur `Select` <br/><br/>Cliquer à nouveau sur `Select` pour sélectionner un groupe de template.<br/>Sélectionner `Templates/Operating systems`                                                                                                                            | <Image src={zljruj} alt="" width="400" height="auto" /><Image src={fjkxur} alt="" width="400" height="auto" /><Image src={abvxlw} alt="" width="400" height="auto" /><Image src={ufotsa} alt="" width="400" height="auto" /> |
