...
import gdtuze from '../../../../../../assets/notes/image/image/_zabbix-1775635342127.jpeg'

import ajbazt from '../../../../../../assets/notes/image/image/_zabbix-1775640911617.jpeg'

import isnmox from '../../../../../../assets/notes/image/image/_zabbix-1775640969131.jpeg'

import yjrrwj from '../../../../../../assets/notes/image/image/_zabbix-1775641026123.jpeg'

import uwfxbc from '../../../../../../assets/notes/image/image/_zabbix-1775641427967.jpeg'
...
Vérifier que tout les prérequis ont tous le statut "<font color="#92d050">OK</font>" <Image src={gdtuze} alt="" width="750" height="auto" />
...
|                                                                                                                                                                                                                                                                                                               |                                                                                                                                                                                                                              |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Sélectionner un Template en cliquant sur `Select` <br/><br/>Cliquer à nouveau sur `Select` pour sélectionner un groupe de template.<br/>Sélectionner `Templates/Operating systems`                                                                                                                            | <Image src={ajbazt} alt="" width="400" height="auto" /><Image src={isnmox} alt="" width="400" height="auto" /><Image src={yjrrwj} alt="" width="400" height="auto" /><Image src={uwfxbc} alt="" width="400" height="auto" /> |
