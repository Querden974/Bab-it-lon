...
import objmho from '../../../../../../assets/notes/image/image/_zabbix-1775635342127.jpeg'

import giwhsh from '../../../../../../assets/notes/image/image/_zabbix-1775640911617.jpeg'

import bekrsw from '../../../../../../assets/notes/image/image/_zabbix-1775640969131.jpeg'

import etvhtl from '../../../../../../assets/notes/image/image/_zabbix-1775641026123.jpeg'

import drgbqu from '../../../../../../assets/notes/image/image/_zabbix-1775641427967.jpeg'
...
Vérifier que tout les prérequis ont tous le statut "<font color="#92d050">OK</font>" <Image src={objmho} alt="" width="750" height="auto" />
...
|                                                                                                                                                                                                                                                                                                               |                                                                                                                                                                                                                              |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Sélectionner un Template en cliquant sur `Select` <br/><br/>Cliquer à nouveau sur `Select` pour sélectionner un groupe de template.<br/>Sélectionner `Templates/Operating systems`                                                                                                                            | <Image src={giwhsh} alt="" width="400" height="auto" /><Image src={bekrsw} alt="" width="400" height="auto" /><Image src={etvhtl} alt="" width="400" height="auto" /><Image src={drgbqu} alt="" width="400" height="auto" /> |
