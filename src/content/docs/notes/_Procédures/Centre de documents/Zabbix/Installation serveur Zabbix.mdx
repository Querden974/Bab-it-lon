...
import faipvg from '../../../../../../assets/notes/image/image/_zabbix-1775635342127.jpeg'

import lvirrp from '../../../../../../assets/notes/image/image/_zabbix-1775640911617.jpeg'

import foxnix from '../../../../../../assets/notes/image/image/_zabbix-1775640969131.jpeg'

import dofqdo from '../../../../../../assets/notes/image/image/_zabbix-1775641026123.jpeg'

import oxeccn from '../../../../../../assets/notes/image/image/_zabbix-1775641427967.jpeg'
...
Vérifier que tout les prérequis ont tous le statut "<font color="#92d050">OK</font>" <Image src={faipvg} alt="" width="750" height="auto" />
...
|                                                                                                                                                                                                                                                                                                               |                                                                                                                                                                                                                              |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Sélectionner un Template en cliquant sur `Select` <br/><br/>Cliquer à nouveau sur `Select` pour sélectionner un groupe de template.<br/>Sélectionner `Templates/Operating systems`                                                                                                                            | <Image src={lvirrp} alt="" width="400" height="auto" /><Image src={foxnix} alt="" width="400" height="auto" /><Image src={dofqdo} alt="" width="400" height="auto" /><Image src={oxeccn} alt="" width="400" height="auto" /> |
