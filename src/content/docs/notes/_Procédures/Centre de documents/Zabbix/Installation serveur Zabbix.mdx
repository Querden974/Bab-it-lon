...
import xiojbu from '../../../../../../assets/notes/image/image/_zabbix-1775635342127.jpeg'

import gjcxbk from '../../../../../../assets/notes/image/image/_zabbix-1775640911617.jpeg'

import clkwcj from '../../../../../../assets/notes/image/image/_zabbix-1775640969131.jpeg'

import psaejd from '../../../../../../assets/notes/image/image/_zabbix-1775641026123.jpeg'

import kwpxjj from '../../../../../../assets/notes/image/image/_zabbix-1775641427967.jpeg'
...
Vérifier que tout les prérequis ont tous le statut "<font color="#92d050">OK</font>" <Image src={xiojbu} alt="" width="750" height="auto" />
...
|                                                                                                                                                                                                                                                                                                               |                                                                                                                                                                                                                              |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Sélectionner un Template en cliquant sur `Select` <br/><br/>Cliquer à nouveau sur `Select` pour sélectionner un groupe de template.<br/>Sélectionner `Templates/Operating systems`                                                                                                                            | <Image src={gjcxbk} alt="" width="400" height="auto" /><Image src={clkwcj} alt="" width="400" height="auto" /><Image src={psaejd} alt="" width="400" height="auto" /><Image src={kwpxjj} alt="" width="400" height="auto" /> |
