...
import exbrxg from '../../../../../../assets/notes/image/image/_zabbix-1775635342127.jpeg'

import fejeuz from '../../../../../../assets/notes/image/image/_zabbix-1775640911617.jpeg'

import tldhmg from '../../../../../../assets/notes/image/image/_zabbix-1775640969131.jpeg'

import lnjvml from '../../../../../../assets/notes/image/image/_zabbix-1775641026123.jpeg'

import zjtbgk from '../../../../../../assets/notes/image/image/_zabbix-1775641427967.jpeg'
...
Vérifier que tout les prérequis ont tous le statut "<font color="#92d050">OK</font>" <Image src={exbrxg} alt="" width="750" height="auto" />
...
|                                                                                                                                                                                                                                                                                                               |                                                                                                                                                                                                                              |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Sélectionner un Template en cliquant sur `Select` <br/><br/>Cliquer à nouveau sur `Select` pour sélectionner un groupe de template.<br/>Sélectionner `Templates/Operating systems`                                                                                                                            | <Image src={fejeuz} alt="" width="400" height="auto" /><Image src={tldhmg} alt="" width="400" height="auto" /><Image src={lnjvml} alt="" width="400" height="auto" /><Image src={zjtbgk} alt="" width="400" height="auto" /> |
