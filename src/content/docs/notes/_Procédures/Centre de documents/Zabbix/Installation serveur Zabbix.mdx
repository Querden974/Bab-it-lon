---
title: Installation serveur Zabbix
editUrl: false
---

import { Image } from 'astro:assets'

import qlczom from '../../../../../../assets/notes/image/image/_zabbix-1775635342127.jpeg'

import ulkpyb from '../../../../../../assets/notes/image/image/_zabbix-1775640911617.jpeg'

import saqcnh from '../../../../../../assets/notes/image/image/_zabbix-1775640969131.jpeg'

import bbovub from '../../../../../../assets/notes/image/image/_zabbix-1775641026123.jpeg'

import qevbeb from '../../../../../../assets/notes/image/image/_zabbix-1775641427967.jpeg'
...
![\_Zabbix-1775631792355.jpeg](../../../../../../assets/notes/image/image/_zabbix-1775631792355.jpeg)
...
:::caution[Il est important de décommenter la ligne avant de sauvegarder le fichier de configuration.] 
:::
...
:::note[Utiliser l'addresse de la machine hôte avec le port configuré dans le fichier nginx de Zabbix]
`http://192.168.92.146:8080`
:::

## 3. Configuration interface WEB

![\_Zabbix-1775635237875.jpeg](../../../../../../assets/notes/image/image/_zabbix-1775635237875.jpeg)

Vérifier que tout les prérequis ont tous le statut "<font color="#92d050">OK</font>" <Image src={qlczom} alt="" width="750" height="auto" />

Renseigner le mot de passe de la base de données.
![\_Zabbix-1775635482568.jpeg](../../../../../../assets/notes/image/image/_zabbix-1775635482568.jpeg)

Renseigner un nom de serveur et définir le fuseau horraire.
![\_Zabbix-1775635580343.jpeg](../../../../../../assets/notes/image/image/_zabbix-1775635580343.jpeg)

Vérifier la configuration pour l'installation de Zabbix
![\_Zabbix-1775635603359.jpeg](../../../../../../assets/notes/image/image/_zabbix-1775635603359.jpeg)

Une fois l'installation terminé, cliquer sur "Finish"
![\_Zabbix-1775635664085.jpeg](../../../../../../assets/notes/image/image/_zabbix-1775635664085.jpeg)

:::note[Pour se connecter la première fois, utiliser les identifiants par défaut: `Admin / zabbix`
:::

## 4. Création d'un utilisateur

Pour pouvoir créer un nouvel utilisateur, aller dans `Users > Users`
![\_Zabbix-1775636111254.jpeg](../../../../../../assets/notes/image/image/_zabbix-1775636111254.jpeg)
Cliquer sur "**Create user**"
![\_Zabbix-1775636185343.jpeg](../../../../../../assets/notes/image/image/_zabbix-1775636185343.jpeg)

Définir un nom d'utilisateur, un mot de passe et associer un groupe.
![\_Zabbix-1775636253807.jpeg](../../../../../../assets/notes/image/image/_zabbix-1775636253807.jpeg)
Dans l'onglet Permissions, cliquer sur "**Select**" et définir un rôle pour le nouvel utilisateur.
![\_Zabbix-1775636356301.jpeg](../../../../../../assets/notes/image/image/_zabbix-1775636356301.jpeg)
...
![\_Zabbix-1775640236767.jpeg](../../../../../../assets/notes/image/image/_zabbix-1775640236767.jpeg)

| ![\_Zabbix-1775640323201.jpeg](../../../../../../assets/notes/image/image/_zabbix-1775640323201.jpeg) | ![\_Zabbix-1775640331462.jpeg](../../../../../../assets/notes/image/image/_zabbix-1775640331462.jpeg) |
| ----------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| ![\_Zabbix-1775640398276.jpeg](../../../../../../assets/notes/image/image/_zabbix-1775640398276.jpeg) | ![\_Zabbix-1775640421275.jpeg](../../../../../../assets/notes/image/image/_zabbix-1775640421275.jpeg) |

### b. Ajouter un hôte

Aller dans `Monitoring > Hosts` puis cliquer sur `Create Host`
![\_Zabbix-1775640651397.jpeg](../../../../../../assets/notes/image/image/_zabbix-1775640651397.jpeg)

|                                                                                                                                                                                                                                                                                                               |                                                                                                                                                                                                                              |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Sélectionner un Template en cliquant sur `Select` <br/><br/>Cliquer à nouveau sur `Select` pour sélectionner un groupe de template.<br/>Sélectionner `Templates/Operating systems`                                                                                                                            | <Image src={ulkpyb} alt="" width="400" height="auto" /><Image src={saqcnh} alt="" width="400" height="auto" /><Image src={bbovub} alt="" width="400" height="auto" /><Image src={qevbeb} alt="" width="400" height="auto" /> |
| Sélectionner également un `Host Group`<br/><br/>Cliquer sur `Add`<br/>Sélectionner `Agent` puis renseigner l'adresse IP du système à surveiller qui contient un agent Zabbix.<br/><br/><font color="#ff0000">Il est important de mettre le même port d'écoute que l'agent installé précédemment. </font><br/> | ![\_Zabbix-1775641929996.jpeg](../../../../../../assets/notes/image/image/_zabbix-1775641929996.jpeg)                                                                                                                        |
...
![\_Zabbix-1775646786376.jpeg](../../../../../../assets/notes/image/image/_zabbix-1775646786376.jpeg)
...
![\_Zabbix-1775646901129.jpeg](../../../../../../assets/notes/image/image/_zabbix-1775646901129.jpeg)

### b. Créer un nouveau déclencheur

Sur la page des déclencheur d'un hôte, cliquer sur `Create Trigger`
![\_Zabbix-1775647198038.jpeg](../../../../../../assets/notes/image/image/_zabbix-1775647198038.jpeg)
...
![\_Zabbix-1775647522877.jpeg](../../../../../../assets/notes/image/image/_zabbix-1775647522877.jpeg)
Cliquer sur `Edit` , puis sélectionner l'item pour la condition et la valeur maximale pour le valider la condition.
![\_Zabbix-1775647823842.jpeg](../../../../../../assets/notes/image/image/_zabbix-1775647823842.jpeg)
...
![\_Zabbix-1775647964698.jpeg](../../../../../../assets/notes/image/image/_zabbix-1775647964698.jpeg)
![\_Zabbix-1775648009632.jpeg](../../../../../../assets/notes/image/image/_zabbix-1775648009632.jpeg)

Une fois le déclencheur configuré, cliquer sur `Add` pour l'ajouter la liste des déclencheurs.
![\_Zabbix-1775648064494.jpeg](../../../../../../assets/notes/image/image/_zabbix-1775648064494.jpeg)
