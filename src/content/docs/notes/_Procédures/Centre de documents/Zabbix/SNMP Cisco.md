...
* Serveur **Zabbix** installé et opérationnel (voir [Installation serveur Zabbix](/notes/_procédures/centre-de-documents/zabbix/installation-serveur-zabbix))
...
:::caution[Ne pas laisser la communauté `public` en production. Utiliser une chaîne personnalisée.
:::
...
:::note[Si `snmpwalk` n'est pas installé :]
...
:::note[Si le template n'est pas présent, l'importer depuis la bibliothèque officielle Zabbix :]
`Data collection > Templates` → **Import**
Fichier disponible sur : [https://www.zabbix.com/integrations/cisco](https://www.zabbix.com/integrations/cisco)
:::
