---
title: Installer une imprimante réseau
editUrl: false
---
...
3. Sur votre moteur de recherche, chercher le pilote de l'imprimante
   ...
   ![imported-image-NgKb.png](../../../../../../assets/notes/image/imported-image-ngkb.png)
4. Sélectionner la plateforme du système d'exploitation et appliquer les filtres
   ![imported-image-IpN.png](../../../../../../assets/notes/image/imported-image-ipn.png)
5. Trouver le programme d'installation, **accepter les conditions de vente**, puis cliquer sur **« Télécharger »**
   ![imported-image-iu.png](../../../../../../assets/notes/image/imported-image-iu.png)
...
6. Lancer le programme d'installation une fois le téléchargement terminé
   ![imported-image-GA.png](../../../../../../assets/notes/image/imported-image-ga.png)
...
7. Accepter le contrat de licence
   ![imported-image-aS.png](../../../../../../assets/notes/image/imported-image-as.png)
