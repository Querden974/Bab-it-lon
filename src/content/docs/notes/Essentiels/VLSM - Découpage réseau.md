...
:::tip[Étape 1 — Trier les besoins du plus grand au plus petit]
...
:::tip[Étape 2 — Trouver la taille de bloc pour chaque besoin]
...
:::tip[Étape 3 — Attribuer les blocs dans l'ordre]
...
* [Calcul sous-réseau](/notes/essentiels/calcul-sous-réseau) — Méthode FLSM (masque fixe), incrément, broadcast
* [Bases des Réseaux Informatiques](/notes/essentiels/bases-des-réseaux-informatiques) — Rappels OSI, TCP/IP, adressage
* [\_Procédures/Centre de documents/Cisco packet Tracer/index](/notes/_procédures/centre-de-documents/cisco-packet-tracer/index) — Mise en pratique sur Packet Tracer
